                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-material">
                                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter blog title" required=""  value="@if(old('title')) {{ old('title') }} @else {{ $blog->title }} @endif">
                                ...
                                <div class="form-group">
                                    <div class="form-material">
                                        <select class="js-select2 form-control" id="cids" name="cids[]" style="width: 100%;" data-placeholder="Select Categories" multiple required="">
                                            ...
                                            <option value="{{ $category->id }}" @if(null !== (old('cids')) && in_array($category->id, old('cids'))) selected @elseif(in_array($category->id, $cids)) selected @endif>{{ $category->title }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{URL::to('/')}}/public/uploads/blog/cover/{{ $blog->header_image }}" class="mt-3" alt="" width="100px">
                                    @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea name="description" id="description" class="js-summernote" required="">@if(old('description')) {{ old('description') }} @else {{ $blog->description }} @endif</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-material">
                                        <input type="text" class="js-tags-input form-control" data-height="34px" id="tag" name="tag" value="@if(old('tag')) {{ old('tag') }} @else {{ $tags }} @endif">
                                ...
                                <div class="form-group">
                                	...
                                	<div class="">
	                                	<label class="css-control css-control-sm css-control-success css-radio">
                                            <input type="radio" class="css-control-input" name="status" required="" value="1" @if($blog->status == 1) checked @endif>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="css-control css-control-primary css-checkbox">
                                        <input type="checkbox" class="css-control-input" value="1" name="hot_post" id="hot_post" @if($blog->hot_post == 1) checked @endif>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-material">
                                        <input type="text" class="form-control js-maxlength" id="meta_title" name="meta_title" placeholder="Enter meta title" value="@if(old('tag')){{old('meta_title')}}@else{{ $blog->meta_title }}@endif" maxlength="60" data-always-show="true" data-placement="top">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-material">
                                        <input type="text" class="js-tags-input form-control" data-height="34px" id="meta_keyword" name="meta_keyword" value="@if(old('tag')){{old('meta_keyword')}}@else{{$blog->meta_keyword}}@endif">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-material">
                                        <textarea name="meta_desc" id="meta_desc" class="form-control js-maxlength" placeholder="Enter meta description" maxlength="155" data-always-show="true" data-placement="top">@if(old('tag')){{old('meta_desc')}}@else{{$blog->meta_desc}}@endif</textarea>
