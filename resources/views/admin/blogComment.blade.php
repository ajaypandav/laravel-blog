...
<div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed">
	...
	<main id="main-container">
	    <!-- Page Content -->
	    <div class="content">
	        <h2 class="content-heading pt-0">Blog Comments <a href="{{ url('/admin/blog') }}" class="btn btn-alt-danger float-right"><i class="fa fa-chevron-circle-left"></i> Back</a></h2>
	        ...
	        <!-- Dynamic Table Full -->
	        <div class="block">
	        	<form method="post" action="{{ route('blogComment.bulk') }}" onsubmit="return submitBulkAction();">
	        		@csrf
...
<script type="text/javascript">
	jQuery('#datatable').dataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: '{{ url('admin/blogComment/'.$blog->id.'/data') }}',
        columns: [
