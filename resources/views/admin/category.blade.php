...
<div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed">
	...
	<main id="main-container">
	    <!-- Page Content -->
	    <div class="content">
	        <h2 class="content-heading pt-0">Categories</h2>
	        ...
	        <!-- Dynamic Table Full -->
	        <div class="block">
	        	<form method="post" action="{{ route('category.bulk') }}" onsubmit="return submitBulkAction();">
	        		@csrf
		        	<div class="block-header block-header-default d-block">
		        		<div class="row">
		        			...
		        			<div class="col-sm-6 text-center text-sm-left">
		        				<a href="{{ route('category.create') }}" class="btn btn-alt-primary float-sm-right"><i class="fa fa-plus"></i> Add New</a>
		        			</div>
		        		</div>
		        	</div>
